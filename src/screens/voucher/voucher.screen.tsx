...
const Voucher = (props: any) => {
  ...
  const getManyVoucher = async () => {
    try {
      ...
      setState({voucherData: res.data, loading: false});
    } catch (error: any) {
  ...
  return (
    <Container>
      <View className="items-center flex-row  p-5">
        <TouchableOpacity
          activeOpacity={0.7}
      ...
      {state.loading ? (
        ...
        <ScrollViewComponent>
          <View className="items-center justify-center px-5 space-y-4 mt-4">
                    ...
                    <View className="flex-row">
                      ...
                      <View className="my-4 flex-col">
                        ...
                        <View className="flex-row items-center space-x-2">
                          ...
                          />
                          <Text className="font-merriweather-regular text-[12px] text-secondary-black ">
                            {isoToDateConvert(item.expire_voucher)}
                          </Text>
                        </View>
                      </View>
                    </View>
